...
class OSSimulator {
    ...
    // --- Process Management ---
    crearProceso(tamanioSolicitado) {
    ...
    intentarAdmitirProcesos() {
        ...
        for (const proceso of porAdmitir){
            if (this.asignarMemoria(proceso)) {
                ...
                // Remove from New
                this.state.colaNew = this.state.colaNew.filter((p)=>p.pid !== proceso.pid);
            }
        }
    }
    ...
    ejecutarTick() {
        ...
        if (!this.state.colaRunning) {
            ...
            } else if (this.state.scheduler === "RoundRobin" && (running.burstTime - running.tiempoRestante) % this.state.quantum === 0) {
    ...
    despacharProceso() {
        ...
        switch(this.state.scheduler){
            ...
            case "RoundRobin":
                ...
                break;
            case "SJF":
                selected = this.state.colaReady.reduce((prev, curr)=>curr.burstTime < prev.burstTime ? curr : prev);
                break;
            case "Prioridades":
                selected = this.state.colaReady.reduce((prev, curr)=>curr.prioridad < prev.prioridad ? curr : prev // Assuming 0 is high priority
                );
                break;
        }
        if (selected) {
            // Remove from Ready
            this.state.colaReady = this.state.colaReady.filter((p)=>p.pid !== selected.pid);
            selected.estado = "running";
            if (selected.tiempoRespuesta === -1) {
                selected.tiempoRespuesta = this.state.tiempoSimulacion - selected.tiempoLlegada;
            }
    ...
    cambioContexto(proceso, destino) {
    ...
    terminarProceso(proceso) {
        proceso.tiempoTurnaround = this.state.tiempoSimulacion - proceso.tiempoLlegada;
    ...
    hayProcesoMejor() {
        ...
        if (this.state.scheduler === "SJF") {
            return this.state.colaReady.some((p)=>p.burstTime < running.tiempoRestante);
        }
    ...
    // --- I/O Management ---
    generarSolicitudIO(proceso) {
        const devices = [
            "disk",
            "printer",
            "monitor",
            "network"
        ]; // Keyboard is manual usually
        const device = devices[Math.floor(Math.random() * devices.length)];
        this.iniciarIO(proceso, device);
    }
    iniciarIO(proceso, device, esManual = false) {
        // Move to Blocked
        ...
        const activeForDevice = this.state.interrupcionesActivas.find((i)=>i.dispositivo === device);
        if (!activeForDevice) {
    ...
    finalizarIO(irq) {
        // Remove interrupt
        this.state.interrupcionesActivas = this.state.interrupcionesActivas.filter((i)=>i.id !== irq.id);
        ...
        if (procIdx !== -1) {
            ...
            this.state.colaBlocked = this.state.colaBlocked.filter((p)=>p.pid !== proceso.pid);
            proceso.estado = "ready";
            this.state.colaReady.push(proceso);
        }
...
function ProcessPanel({ state, onCreate }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: "p-4 h-[500px] flex flex-col border-border",
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "grid grid-cols-5 gap-2 mb-2 text-xs font-semibold text-muted-foreground text-center",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: "PID / Estado"
                    }, void 0, false, {
...
//# sourceMappingURL=_593ef344._.js.map